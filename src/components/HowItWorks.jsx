...
const HowItWorks = () => {
  return (
    <section className="relative w-full bg-white py-24" id="how-it-works">
      <div className="max-w-7xl mx-auto px-8 flex items-center gap-8">
        {/* Left column - text */}
        <div className="w-1/2 space-y-8">
          <h2 className="text-5xl font-black text-secondary">How It Works</h2>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg font-medium capitalize text-black/50 mt-2 max-w-xl">
