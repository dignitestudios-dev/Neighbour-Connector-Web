...
const AboutUs = () => {
  return (
    <section className="relative w-full bg-white py-24" id="about">
      <div className="max-w-7xl mx-auto px-8 flex items-center gap-12">
        ...
        <div className="w-1/2 space-y-6">
          <h2 className="text-5xl font-black text-secondary">About Us</h2>

          <p className="text-lg font-medium capitalize text-black/50 leading-relaxed">
