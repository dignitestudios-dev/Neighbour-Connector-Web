...
const Resources = () => {
  return (
    <section className="relative w-full bg-white py-12 md:py-20" id="resources">
        ...
        <div className="rounded-2xl border border-[#E6F3C9] bg-[#EEF7DE] px-6 py-12 md:px-10 md:py-16">
          ...
          <div className="mt-8 md:mt-10 text-center text-black/70 space-y-2">
            <p className="text-lg md:text-2xl font-semibold text-primary">
              Neighbor Connector<sup className="text-[10px] font-semibold ml-1 mb-3">TM</sup> Library
            </p>
            ...
            <p className="text-sm md:text-lg">- Articles/Newsletters/Blogs</p>
          </div>
        </div>
      </div>
    </section>
